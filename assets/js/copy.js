...
const COPY = {
  ...
  s5: {
    ...
    zh: {
      ...
      buildRows: [
        ...
        { k: 'prompt 迭代轮数', v: '[TODO：封版时填]' },
        { k: 'commit 数', v: '[TODO：封版时填]' },
  ...
  s6: {
    en: {
      ...
      indexStatus: '[TODO: fill after publication] Checked in Google on [DATE]: [result].',
    },
    zh: {
      madeBy: '作者',
      ...
      indexStatus: '[TODO：上线后填] 于 [日期] 在 Google 检索本页：[结果]。',
    },
  },
